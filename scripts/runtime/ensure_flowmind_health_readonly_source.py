#!/usr/bin/env python3
"""Ensure the FlowMind health readonly executor source exists via Crazy's façade."""
...
DEFAULT_SPEC_PATH = ROOT / "shared-context" / "executor-sources" / "flowmind-health-readonly-openapi.v1.json"
...
def main() -> int:
    ...
    parser.add_argument("--namespace", default="flowmind-health-readonly")
    parser.add_argument("--name", default="FlowMind Health Readonly")
    parser.add_argument("--spec-path", default=str(DEFAULT_SPEC_PATH))
    parser.add_argument("--base-api-url", default="http://111.229.194.203:3301")
    parser.add_argument("--required-tool", default="getReadyz")
