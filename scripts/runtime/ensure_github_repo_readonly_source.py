#!/usr/bin/env python3
"""Ensure the GitHub repository readonly executor source exists via Crazy's façade."""
...
DEFAULT_SPEC_PATH = ROOT / "shared-context" / "executor-sources" / "github-repo-readonly-openapi.v1.json"
...
def main() -> int:
    ...
    parser.add_argument("--namespace", default="github-repo-readonly")
