#!/usr/bin/env python3
"""Ensure the Hacker News Algolia readonly executor source exists via Crazy's façade."""
...
DEFAULT_SPEC_PATH = ROOT / "shared-context" / "executor-sources" / "hn-algolia-search-openapi.v1.json"
...
def main() -> int:
    ...
    parser.add_argument("--namespace", default="hn-readonly")
    parser.add_argument("--name", default="Hacker News Readonly")
    parser.add_argument("--spec-path", default=str(DEFAULT_SPEC_PATH))
    parser.add_argument("--base-api-url", default="https://hn.algolia.com")
